            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#Requesting Chemicals ">Approval/Reject Chemical Request</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#Requesting Status">Create User</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#Chemicals Database">Chemicals Database</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#contact">Contact Developer</a>
                        </li>
                        <li class="nav-item">
                            <div class="dropdown">
            ...
            <div class="row project">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                <h4 class="card-title">Approval/Reject Chemical Request </h4>
                                <button>more</button>
                            </div>
                        </div>
                    </div>
